...
require (
	...
	github.com/rancher/steve v0.3.3
...
require (
	...
	k8s.io/pod-security-admission v0.30.13 // indirect
...
require (
	...
	k8s.io/cluster-bootstrap v0.30.13 // indirect
